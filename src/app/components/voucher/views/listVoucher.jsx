...
function GetListVoucher(props) {
  ...
  const axiosRecallVoucherController = async () => {
    ...
    requestRecallVoucher.reasonRecall =
      document.getElementById("recallInput").value;
    requestRecallVoucher.voucherIds = isCheck;
    setRequestRecall({
      reasonRecall: document.getElementById("recallInput").value,
      voucherIds: isCheck,
    });
    setShow(false);
    ...
    <>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={axiosRecallVoucherController}>
            Thu hồi voucher
          </Button>
        </Modal.Footer>
      </Modal>
      <div className="card">
        <div className="card-body">
          <h3 className="card-content-title">Danh sách Voucher</h3>
          <div className="row ">
